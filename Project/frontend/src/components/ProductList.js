    ...
    return (
        <React.Fragment>
            ...
            <tr role="row">
                ...
                <td className="td-product" role="cell"><a href={`https://roostermusic.com/images/products/${props.image}`} target="_blank" rel="noreferrer"><img src={`http://localhost:3000/images/products/${props.image}`} alt="producto" /></a></td>
                ...
                <td className="td-product" role="cell"><a href={`https://roostermusic.com/products/detail/${props.id_product}`} target="_blank" rel="noreferrer">Ir a sitio</a></td>
            </tr>
            {/* <!-- /Fila --> */}
        </React.Fragment>
    )
